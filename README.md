...
pnpm convex:dev              # Convex backend (uses the repo-pinned CLI)
pnpm dev                     # Portless Next.js proxy (https://buzz.localhost)
```
...
```bash
pnpm dev            # Portless Next dev proxy (https://buzz.localhost)
